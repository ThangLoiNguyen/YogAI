      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-8 px-4 py-10">
        ...
        <section className="grid gap-6 md:grid-cols-3">
          <div className="flex flex-col rounded-2xl border border-sky-100 bg-white p-5 shadow-sm shadow-sky-50">
            <p className="text-xs font-semibold text-slate-700">Gói cơ bản</p>
          ...
          <div className="flex flex-col rounded-2xl border border-sky-400 bg-white p-5 shadow-lg shadow-sky-100">
            <p className="text-xs font-semibold text-sky-700">Gói Pro</p>
            <p className="mt-2 text-2xl font-semibold text-sky-600">
              19$/tháng
            </p>
            <p className="mt-2 text-xs text-slate-600">
              CRM học viên, nhật ký buổi học và trình xây giáo án cơ bản.
            </p>
          </div>

          <div className="flex flex-col rounded-2xl border border-sky-100 bg-white p-5 shadow-sm shadow-sky-50">
            <p className="text-xs font-semibold text-slate-700">Gói AI Studio</p>
            <p className="mt-2 text-2xl font-semibold text-sky-600">
              39$/tháng
            </p>
            <p className="mt-2 text-xs text-slate-600">
              Full AI engine: Matching, Curriculum, phân tích học viên & Trợ lý
              Marketing.
            </p>
          </div>
        </section>
